...
export function normalizeQuadIn(val: any, min: any, max: any) {
    return Math.pow(normalize(val, min, max), 2);
}
export function normalizeQuadOut(val: any, min: any, max: any) {
...
export function scaleAndCenter(_geometry:any, _bounds:any, _center:any) {
    if (_center === void 0) {
        _center = 'xyz';
    }
    ...
    export function zTween(_val: number, _target: number, _ratio: number) {
