/**
 * 针对2D的速度改进的perlin和单纯形噪声算法。
 *
 * 基于Stefan Gustavson的示例代码（stegu@itn.liu.se）。
 * Peter Eastman的优化（peastman@drizzle.stanford.edu）。
 * Stefan Gustavson在2012年提出了更好的等级排序方法。
 */
...
class Perlin {
  ...
  perlin2(x, y) {
    // console.error(gradP, "gradP");
    // console.error(perm, "perm");
